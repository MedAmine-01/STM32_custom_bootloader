...
void decode_menu_command_code(uint32_t command_code){
    ...
    switch(command_code){
        ...
        case 1:
            ...
            write_serial_port(&data_buf[0],1);
            write_serial_port(&data_buf[1],COMMAND_BL_GET_VER_LEN-1);
        ...
        case 2:
            ...
            data_buf[5] = word_to_byte(crc32,4,1);
            write_serial_port(&data_buf[0],1);
            write_serial_port(&data_buf[1],COMMAND_BL_GET_HELP_LEN-1);
            ret_value = read_bootloader_reply(data_buf[1]);
            break;
        ...
        case 3:
            ...
            data_buf[5] = word_to_byte(crc32,4,1);
            write_serial_port(&data_buf[0],1);
            write_serial_port(&data_buf[1],COMMAND_BL_GET_CID_LEN-1);
            ret_value = read_bootloader_reply(data_buf[1]);
            break;
        ...
        case 4:
            ...
            data_buf[5] = word_to_byte(crc32,4,1);
            write_serial_port(&data_buf[0],1);
            write_serial_port(&data_buf[1],COMMAND_BL_GET_RDP_STATUS_LEN-1);
            ret_value = read_bootloader_reply(data_buf[1]);
            break;
        ...
        case 5:
            ...
            write_serial_port(&data_buf[0],1);
            write_serial_port(&data_buf[1],COMMAND_BL_GO_TO_ADDR_LEN-1);
            ret_value = read_bootloader_reply(data_buf[1]);
            break;
        ...
        case 7:
            ...
            write_serial_port(&data_buf[0],1);
            write_serial_port(&data_buf[1],COMMAND_BL_FLASH_ERASE_LEN-1);
            ret_value = read_bootloader_reply(data_buf[1]);
            break;
        case 8:
            ...
            while(bytes_remaining)
            {
                ...
                read_file(&data_buf[7],len_to_read);
                printf("\n   base mem address = %#.8x\n",base_mem_address);
                ...
                write_serial_port(&data_buf[0],1);
                write_serial_port(&data_buf[1],mem_write_cmd_total_len-1);
            ...
            case 9:
                ...
                write_serial_port(&data_buf[0],1);
                write_serial_port(&data_buf[1],COMMAND_BL_EN_R_W_PROTECT_LEN-1);
        ...
        case 11:
            ...
            write_serial_port(&data_buf[0],1);
            write_serial_port(&data_buf[1],COMMAND_BL_READ_SECTOR_P_STATUS_LEN-1);
        ...
        case 13:
            ...
            write_serial_port(&data_buf[0],1);
            write_serial_port(&data_buf[1],COMMAND_BL_DIS_R_W_PROTECT_LEN-1);
        ...
        case 14:
            ...
            write_serial_port(&data_buf[0],1);
            write_serial_port(&data_buf[1],COMMAND_BL_MY_NEW_COMMAND_LEN-1);
